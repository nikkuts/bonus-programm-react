...
export default function Rules () {
  ...
  return (
    ...
    <p>Бонуси з бонусного рахунку можна використовувати для підтримки проєкту, замовляти платні продукти та виводити на власну банківську карту, починаючи від суми <span className={css.num}>40</span> гривень.</p>
